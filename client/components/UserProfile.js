      ...
      {dogInfo ? (
        <div>
          ...
          <Carousel interval={null} variant="dark">
            <Carousel.Item>
              <img
                className="flex items-center active:bg-indigo-500 hover:bg-indigo-300 mr-2 rounded-md w-16 h-16 cursor-pointer border-solid border-2 border-indigo-600"
                src={dogInfo.img_src}
          ...
          <div className="match-names mt-2">
            <h2>{dogInfo.name}</h2>
            <div className="mb-2" id="match-owner">
              {dogInfo.owner}
            </div>
          </div>
          <div className="specs">
